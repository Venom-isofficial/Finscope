  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-gradient-to-b from-brand-primary via-brand-secondary to-brand-primary overflow-hidden">
      <div className="relative flex flex-col items-center">
        ...
        {/* Brand Logomark */}
        <div className="relative z-10 w-24 h-24 mb-6 rounded-3xl bg-brand-card flex items-center justify-center border border-brand-accent/20 shadow-[0_0_50px_rgba(182,255,90,0.15)]"
        >
          ...
          <div
            className="absolute inset-0 rounded-3xl border border-brand-accent" />
        </div>
