    ...
    <div className="flex flex-col pb-32 pt-6 px-4 max-w-lg mx-auto w-full relative z-10">
      ...
      <div className="glass-panel rounded-[24px] p-5 mb-6 flex items-center gap-4 relative overflow-hidden shadow-xl border border-white/5">
        ...
        <div className="min-w-0">
          ...
          <p className="text-xs text-brand-text-secondary mt-1 font-medium truncate">{user?.email || "investor@finscope.ai"}</p>
          <p className="text-[9px] text-brand-text-secondary/60 font-mono mt-1 font-bold">Country: {user?.country || "United States"}</p>
        </div>
      </div>
      ...
      <div className="mb-6">
        <h3 className="text-xs font-mono tracking-widest text-brand-text-secondary uppercase mb-3 flex items-center gap-1.5 font-bold">
        ...
        <div className="grid grid-cols-3 gap-2.5">
          ...
          >
            <div className="w-5 h-5 rounded-full bg-brand-primary mx-auto mb-2 border border-brand-accent/40 flex items-center justify-center">
              {settings.theme === "dark-green" && <Check className="w-3 h-3 text-brand-accent" />}
            </div>
